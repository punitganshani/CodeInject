...
namespace CInject.Extensions
{
    public static class MonoExtensions
    {
        ...
        internal static void UpdateReferences(this IEnumerable<Instruction> collection, Instruction oldTarget, Instruction newTarget)
        {
        ...
        internal static void UpdateReferences(this IEnumerable<ExceptionHandler> handlers, Instruction oldTarget, Instruction newTarget)
        {
        ...
        internal static void ReplaceAll(this Instruction[] labels, Instruction oldTarget, Instruction newTarget)
        {
        ...
        internal static Runtime GetRuntime(this ModuleDefinition module)
        {
